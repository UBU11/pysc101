...
export const siteConfig: SiteConfig = {
	...
	banner: {
		enable: true,
		src: "assets/images/moon.jpg", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
	...
	links: [
		{
			...
			url: "https://x.com/ubu10",
		},
			{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/UBU11",
		},
		{
			name: "Discord",
			icon: "fa6-brands:discord",
			url: "https://discordapp.com/users/701417475782213642",
		},
